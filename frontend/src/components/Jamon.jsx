            ...
            <Grid container spacing={6} alignItems="flex-start">
              ...
              <Grid item xs={12} md={7}>
                ...
                <Typography paragraph>
                  ...
                  <strong>3º mejor cortador de Andalucía</strong>, es el que
                  pone su toque en cada plato de jamón ibérico que servimos.
                  Disfruta del jamón recién cortado en directo aquí en nuestra
                  cervecería.
                </Typography>
          ...
          <Container maxWidth="lg">
            ...
            <Box sx={{ position: "relative", maxWidth: 800, mx: "auto" }}>
              ...
              <IconButton
                onClick={() =>
                  setIdx(
                    (i) => (i - 1 + jamonImages.length) % jamonImages.length
                  )
                }
                sx={{
                  position: "absolute",
